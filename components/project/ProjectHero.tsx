    ...
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden pt-24 pb-12">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 md:px-12 w-full max-w-7xl mx-auto -mt-16 md:-mt-24">
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center justify-center">
          <button className="group relative px-10 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 overflow-hidden font-bold transition-all uppercase tracking-widest text-sm shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_40px_rgba(34,211,238,0.7)] hover:-translate-y-1 w-full sm:w-auto">
          ...
          <button className="group relative px-10 py-4 rounded-xl border border-white/20 bg-white/5 backdrop-blur-sm overflow-hidden font-bold transition-all uppercase tracking-widest text-sm hover:border-cyan-400/60 hover:bg-cyan-900/20 hover:-translate-y-1 w-full sm:w-auto">
            ...
            <span className="relative flex items-center justify-center gap-3 text-white">
              <Play className="w-4 h-4 text-cyan-400 group-hover:scale-125 transition-transform duration-300" />
              Watch Demo
            </span>
          </button>
        </div>
