...
const confettiParticles = Array.from({ length: 40 }).map((_, i) => ({
  ...
  color: Math.random() > 0.6 ? "bg-amber-200/60" : "bg-blue-300/40",
          ...
          >
            <div style={{ transform: `rotate(-${startAngle}deg)` }}>
              <div className="planet-core group/core cursor-pointer relative flex flex-col items-center justify-center">
                ...
                <div 
                  className="relative h-12 w-12 sm:h-16 sm:w-16 lg:h-20 lg:w-20 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] origin-center group-hover/core:scale-[2.2] drop-shadow-[0_0_12px_rgba(59,130,246,0.6)] group-hover/core:drop-shadow-[0_0_25px_rgba(59,130,246,0.9)]"
                >
                  <div 
                    className={cx(
                      ...
                      "bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-blue-500 via-blue-700 to-blue-950",
                ...
                <div className="absolute top-[120%] opacity-0 transform translate-y-4 transition-all duration-500 ease-out group-hover/core:opacity-100 group-hover/core:translate-y-0 flex flex-col items-center pointer-events-none z-50">
                  <div className="px-3 py-1.5 rounded-full bg-[#02040A]/80 border border-blue-500/30 backdrop-blur-xl shadow-[0_0_20px_rgba(0,0,0,0.8)] flex flex-col items-center whitespace-nowrap">
                    <span className="text-xs lg:text-sm font-medium tracking-[0.15em] text-white">{b.name}</span>
                    <span className="text-[9px] lg:text-[10px] font-bold uppercase tracking-[0.2em] text-blue-400 mt-0.5">
                      {b.role}
                    </span>
                  </div>
                </div>
...
const team: Bubble[] = [
  ...
  { name: "Munim", role: "Engineer", img: "/images/team/munim.jpg" },
  { name: "Tisha", role: "Lead", img: "/images/team/tisha.jpg" },
  ...
  return (
    ...
    >
      <style dangerouslySetInnerHTML={{
        ...
        @keyframes slipstream-enter { 0% { opacity: 0; background: transparent; transform: scale(1); } 100% { opacity: 1; background: linear-gradient(to bottom, transparent, #061838); transform: scale(1.1); } }
      ...
      {isWarping && (
        <div className="fixed inset-0 z-[200] bg-black flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute w-[200px] h-[200px] border-[2px] border-blue-400/50 rounded-full animate-[wormhole_1.5s_ease-in_0.3s_forwards]" />
      ...
      {projectLaunch.active && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center overflow-hidden pointer-events-none">
          ...
          {projectLaunch.phase === "liftoff" && <div className="absolute inset-0 animate-[slipstream-enter_1.5s_ease-in_forwards] z-[-1] bg-[#030e21]" />}
          <div className={cx("relative z-10 font-black tracking-tighter text-transparent bg-clip-text transition-all duration-300", projectLaunch.phase === "counting" ? "text-[10rem] md:text-[15rem] bg-gradient-to-b from-blue-300 to-indigo-700 animate-pulse drop-shadow-[0_0_30px_rgba(59,130,246,0.4)]" : "text-5xl md:text-7xl bg-gradient-to-b from-blue-100 to-white drop-shadow-[0_0_50px_rgba(59,130,246,0.8)] tracking-[0.1em]")}>
            {projectLaunch.text}
          </div>
        </div>
      )}
      ...
      <section className="relative h-[100dvh] w-full flex flex-col items-center justify-center z-50">
        ...
        <div className="relative w-[300px] h-[300px] sm:w-[420px] sm:h-[420px] lg:w-[500px] lg:h-[500px] xl:w-[550px] xl:h-[550px] flex items-center justify-center mt-8 sm:mt-12 lg:mt-16 z-50">
            ...
            >
              <div className="absolute inset-[-50%] bg-[radial-gradient(circle_at_center,rgba(20,70,140,0.6)_0%,rgba(10,25,60,0.25)_45%,transparent_70%)] blur-[12px] rounded-full transition-all duration-700 group-hover:opacity-0 group-hover:scale-50 pointer-events-none" />
              <div className="absolute inset-[-20%] bg-[radial-gradient(circle_at_center,rgba(40,120,220,0.3)_0%,transparent_60%)] blur-[25px] rounded-full transition-all duration-700 group-hover:opacity-0 group-hover:scale-50 pointer-events-none" />

              <div className="absolute inset-0 bg-gradient-to-tr from-blue-700/30 to-sky-500/30 blur-[70px] rounded-full opacity-0 transition-all duration-700 group-hover:opacity-100 group-hover:scale-[1.5]" />
              <div className="absolute inset-[-10%] rounded-full border border-blue-500/20 border-dashed opacity-0 scale-50 transition-all duration-1000 ease-out group-hover:opacity-100 group-hover:scale-100 group-hover:animate-[spin_12s_linear_infinite]" />

              <img
                src={DIAMOND_LOGO}
                alt="Team Diamonds Logo"
                className="relative z-10 w-full h-full object-contain drop-shadow-[0_0_20px_rgba(25,90,180,0.4)] animate-float transition-all duration-700 group-hover:scale-0 group-hover:opacity-0 group-hover:-rotate-90"
              />
            ...
            <div className="absolute inset-0 pointer-events-none z-0">
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[60%] h-[60%] border-2 border-blue-500/15 rounded-full border-dashed drop-shadow-[0_0_8px_rgba(96,165,250,0.3)]" />
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] h-[100%] border-2 border-indigo-500/15 rounded-full border-dashed drop-shadow-[0_0_8px_rgba(99,102,241,0.3)]" />
              <div className="absolute inset-0 border border-indigo-400/5 rounded-full shadow-[inset_0_0_40px_rgba(59,130,246,0.03)]" />
            </div>
        ...
        <div className="absolute bottom-12 lg:bottom-16 w-full max-w-[90rem] mx-auto px-6 sm:px-12 flex flex-row items-end justify-between z-50 pointer-events-none">
          ...
          <div className="flex justify-start pointer-events-auto">
            ...
            >
              <div className="relative w-14 h-20 sm:w-16 sm:h-24 lg:w-20 lg:h-28 clip-diamond-ship bg-gradient-to-b from-blue-400 via-indigo-700 to-[#02040A] flex items-center justify-center z-10 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-tr from-white/20 to-transparent opacity-50 pointer-events-none" />
                <Rocket className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-blue-100 -mt-2 lg:-mt-4 drop-shadow-[0_0_12px_rgba(59,130,246,0.7)]" />
                <div className="absolute top-6 sm:top-8 w-2 h-2 sm:w-3 sm:h-3 rotate-45 bg-blue-300 shadow-[0_0_10px_rgba(96,165,250,0.6)]" />
              </div>

              <div className="relative w-8 h-6 sm:w-10 sm:h-8 lg:w-12 lg:h-10 -mt-2 lg:-mt-3 bg-blue-600/50 blur-[12px] opacity-0 group-hover:opacity-100 animate-[plasma-pulse_1.5s_infinite] origin-top z-0 rounded-b-full" />
              <div className="w-16 sm:w-20 lg:w-24 h-1.5 sm:h-2 rounded-full bg-gradient-to-r from-transparent via-blue-800 to-transparent mt-1" />

              <span className="mt-2 sm:mt-4 text-[9px] sm:text-[10px] lg:text-xs font-bold tracking-[0.2em] text-blue-400 uppercase group-hover:text-blue-200 transition-colors drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]">
                Explore Project
              </span>
            </button>
          </div>
