    ...
    <div className="force-trebuchet mx-auto max-w-4xl z-10 relative mt-[-80px] sm:mt-[-100px] px-4">
      ...
      <div
        ...
        className={cx(
          ...
          "hover:-translate-y-3 hover:shadow-[0_20px_80px_-20px_rgba(34,211,238,0.2)] hover:border-cyan-500/30"
        )}
      >
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-[1px] bg-gradient-to-r from-transparent via-cyan-400/40 to-transparent opacity-50 group-hover:opacity-100 group-hover:w-full group-hover:via-cyan-300 transition-all duration-700 z-0" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-[2px] bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent opacity-60 group-hover:opacity-100 group-hover:w-3/4 group-hover:via-cyan-400 transition-all duration-700 z-0 shadow-[0_-5px_15px_rgba(34,211,238,0.3)]" />
        
        <div className="absolute -top-24 -right-24 w-64 h-64 bg-cyan-500/10 blur-[60px] rounded-full group-hover:bg-cyan-500/20 transition-colors duration-700 pointer-events-none z-0" />
        ...
        <div className="relative flex flex-col items-center text-center gap-6 sm:gap-8 z-10 pointer-events-none">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center justify-center gap-3 text-sm sm:text-base lg:text-lg text-white/70 group-hover:text-white transition-colors duration-300">
              <span className="inline-flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-cyan-500/10 border border-cyan-500/20 group-hover:bg-cyan-500/20 group-hover:border-cyan-400/50 group-hover:shadow-[0_0_15px_rgba(34,211,238,0.4)] transition-all duration-300 shrink-0">
                <BadgeCheck className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-cyan-300" />
              </span>
          ...
          <div className="mt-2 sm:mt-4 pt-6 border-t border-white/5 w-full max-w-2xl flex flex-wrap justify-center items-center gap-2 sm:gap-4 text-[9px] sm:text-[11px] text-cyan-200/40 uppercase tracking-[0.2em] group-hover:text-cyan-200/70 transition-colors duration-500">
            <span>Team Diamonds</span>
            <span className="hidden sm:inline w-1 h-1 rounded-full bg-cyan-500/50" />
            <span>NASA Space Apps Challenge 2022</span>
            <span className="hidden sm:inline w-1 h-1 rounded-full bg-cyan-500/50" />
            <span className="text-purple-300/50 group-hover:text-purple-300/90 drop-shadow-[0_0_8px_rgba(168,85,247,0)] group-hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.5)] transition-all duration-500">
              Diamond in the Sky
            </span>
          </div>
        </div>
      ...
      <div className="mt-24 sm:mt-32 mb-12 w-full h-[1px] bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent" />
    </div>
  );
}